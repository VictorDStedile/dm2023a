...
ArbolEstimarGanancia  <- function( semilla, param_basicos )
{
  ...
  particionar( dataset, division=c(7,3), agrupa="clase_ternaria", seed= 357755 )
...
dir.create( "C:\\Users\\victo\\OneDrive\\Escritorio\\Maestría_Data_Science\\Modulo_2_Mineria_datos\\exp\\HT2020", showWarnings = FALSE )
archivo_salida  <- "C:\\Users\\victo\\OneDrive\\Escritorio\\Maestría_Data_Science\\Modulo_2_Mineria_datos.\\exp\\HT2020\\gridsearch.txt"
...
for (vmin_bucket in c(2, 3, 4, 5, 6, 7))
      {
